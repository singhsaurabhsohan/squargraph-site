...
<section class="home-section architecture-section architecture-founder">
  <div class="architecture-shell architecture-founder-grid">
    ...
    <div><p class="section-eyebrow">The Founder</p><h2>Saurabh Sohan Singh</h2><p class="architecture-founder-role">Founder &amp; Creative Strategist</p><p class="founder-secondary-role">Integrated Marketing &amp; Brand Communications Professional</p><h3>Built by understanding how brands move in the real world.</h3><p>Saurabh brings more than eight years of experience across social media strategy, integrated digital campaigns, content, influence, brand communications, PR and production. His professional background includes work with INNOCEAN Worldwide India on the Hyundai Motor India mandate, connecting client, creative, media, production and partner teams across complex, public-facing brand initiatives.</p><p>Today, he brings this experience to SQUARGRAPH™, shaping selected brand, creative and digital engagements with a focus on strategic clarity, connected execution and long-term brand value.</p><div class="architecture-founder-links"><a class="text-link" href="/saurabh-sohan-singh" data-sq-event="founder_profile_click">Meet the Founder</a><a class="text-link" href="https://linkedin.com/in/saurabhsohansingh" target="_blank" rel="noopener noreferrer">LinkedIn</a><a class="text-link" href="mailto:saurabh@squargraph.com">Email</a></div></div>
  </div>
</section>
