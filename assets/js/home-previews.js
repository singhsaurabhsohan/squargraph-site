...
(function () {
  ...
  var brandMarks = [
    ...
    { name: 'YASHICA', src: '/assets/images/brand-marks/yashica.png', className: 'brand-marquee-item--yashica' },
    { name: 'Angelbird', src: '/assets/images/brand-marks/angelbird.svg', className: 'brand-marquee-item--angelbird' },
